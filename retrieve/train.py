...
if __name__ == '__main__':
    ...
    if conf.mode == "train":
        ...
        saved_model_path = os.path.join(
            conf.output_path, conf.saved_model_path)
